...
const World = React.lazy(() => import("@/components/ui/globe").then((m) => ({ default: m.World } as { default: React.ComponentType<any> })));
      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
          ...
          <p className="text-center text-base md:text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-lg mt-2 mx-auto">
            Helping users globally to maintain grid systems and empower sustainability
          </p>
        </motion.div>
